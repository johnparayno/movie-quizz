...
- **Seed data**: Content is loaded from `data/pua_dataset_merged_unique_v2.json`. Map fields to Content Item attributes (id, text, content_type, active, created_at); derive or default missing attributes as needed.
